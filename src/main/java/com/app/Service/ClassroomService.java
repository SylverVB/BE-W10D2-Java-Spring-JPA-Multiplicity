...
/**
 * This service class demonstrates how to retrieve or manipulate the entities related to the Classroom entity.
 */
@Service
public class ClassroomService {
    ...
    /**
     * Unassign a student from a classroom while retrieving only the classroom entity.
     * @param classroomId the Id of an already existing classroom entity.
    ...
    public void removeStudentFromClassroom(long classroomId, long studentId){
        ...
        if(classroomOptional.isPresent()){
            Classroom classroom = classroomOptional.get();
            // lambda expression applied to the collection - this is the same as iterating through 
            // the student list and removing if(student.getId() == studentId)
